...
public class FeatureSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FeatureBody featureBody = (FeatureBody)theEObject;
        T result = caseFeatureBody(featureBody);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case FeaturePackage.ATTRIBUTE_PART:
      {
        AttributePart attributePart = (AttributePart)theEObject;
        T result = caseAttributePart(attributePart);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case FeaturePackage.FEATURE_EXPR:
      {
        ...
        T result = caseFeatureExpr(featureExpr);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case FeaturePackage.LOGIC_EXPR:
      {
        LogicExpr logicExpr = (LogicExpr)theEObject;
        T result = caseLogicExpr(logicExpr);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * @generated
   */
  public T caseFeatureBody(FeatureBody object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Attribute Part</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Attribute Part</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseAttributePart(AttributePart object)
  {
    return null;
  }
   ...
   * @generated
   */
  public T caseFeatureExpr(FeatureExpr object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Logic Expr</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Logic Expr</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseLogicExpr(LogicExpr object)
  {
    return null;
  }
